...
func TestAuth(t *testing.T) {
	testData := []struct {
		...
		{"alternative Linn.", []string{"Linne"}, []string{"Linn."}, 1756, 1800, "00000001_00000000_00000000_00000000"},
		{"alternative Linn. 2", []string{"Linné"}, []string{"Linn."}, 1756, 1800, "00000001_00000000_00000000_00000000"},
		{"alternative Sokoloff", []string{"Sokoloff"}, []string{"Sokolov"}, 1756, 1800, "00000001_00000000_00000000_00000000"},
